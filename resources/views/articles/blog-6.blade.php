                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                <!-- News Head -->
                                <div class="news-head">
                                    <img src="https://sumberbrantas.id/wp-content/uploads/2022/09/2.jpg" alt="#">
                                </div>
                                <!-- News Title -->
                                ...
                                <!-- News Text -->
                                <div class="news-text">
                                    <p>Pemerintah Desaa Sumberbrantas bersama para petani dalam meningkatkan hasil panen di
                                        wilayah daerah, siap menjadikan panen dengan penggunaan pupuk organik.</p>
                                </div>
