                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                <!-- News Head -->
                                <div class="news-head">
                                    <img src="https://sumberbrantas.id/wp-content/uploads/2023/01/1-scaled.jpg"
                                        alt="#">
                                </div>
                                <!-- News Title -->
                                <h1 class="news-title"><a href="">Kitab Budaya Sumberbrantas karya Tim MBKM FISIP
                                        Membangun Desa Universitas Brawijaya</a></h1>
                                <!-- Meta -->

                                <!-- News Text -->
                                <div class="news-text">
                                    <p>Pada tanggal 30 Desember 2022, tim MBKM FISIP Membangun Desa resmi menyelesaikan
                                        pengabdian di Desa Sumberbrantas. Menutup pengabdian, tim MBKM FISIP Membangun Desa
                                        menyerahkan buku Kitab Budaya yang berisikan berbagai macam seni yang ada di Desa
                                        Sumberbrantas. Selain sebagai kenangan perpisahan, tim MBKM FISIP Membangun Desa
                                        berharap buku ini dapat membangkitkan kembali semangat berbudaya di Desa
                                        Sumberbrantas dan memperkenalkan budaya Desa Sumberbrantas kepada masyarakat luar.
                                    </p>

                                    <blockquote class="overlay">
                                        <p>Budayaku, Indonesiaku!</p>
                                    </blockquote>
